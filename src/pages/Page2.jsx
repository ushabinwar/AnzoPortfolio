...
const Page2 = () => {
  ...
  return (
    <div id='section2' className='bg-white text-black text-center p-10 '>
        <h3 className='text-gray-300 text-[1.3vw] font-thin font-[anzo3]'>©  anzo.studio 2024 | designed and developed</h3>
        <div className='rotateText mt-24 bg-red-300'>
            <h1 className='text-[41vw]  font-[anzo5] leading-[33vw]'>IMPACTFUL</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo5] leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo5] leading-[33vw]'>IS THE</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo5] leading-[33vw]'>DESIGN</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo5] leading-[33vw]'>THAT</h1>
        </div>
        <div className='rotateText'>
            <h1 className='text-[41vw] font-[anzo5] leading-[33vw]'>WORKS!</h1>
        </div>


        <div className='flex justify-center items-center scale-50 mt-10'>
    ...
    <g>
        ...
        <div className='w-80 h-[.2vh] bg-black relative left-1/2 -translate-x-1/2  mt-12'>
