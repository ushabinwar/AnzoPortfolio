...
const Page1 = () => {
  ...
  return (
    <div id='page1' onMouseMove={(e) => {mouseMoving(e)}} className='h-screen bg-white text-white px-4 py-3'>
        <div id='page1-in' className=' shadow-xl px-20 py-12 shadow-gray-700 h-full w-full bg-cover bg-black rounded-[40px] bg-[url(https://static.wixstatic.com/media/f1c650_678c0ceab5194893872c60fa3be4bcdc~mv2.jpg/v1/fill/w_1861,h_874,fp_0.69_0.64,q_85,usm_0.66_1.00_0.01,enc_auto/ANZO.jpg)]'>
